...
const SRC_FILE = path.join('.', 'QBTable.js');
const ES5_FILE = path.join('.', 'QBTable.es5.js');
const BROWSERIFY_FILE = path.join('.', 'QBTable.browserify.js');
const MINIFIED_FILE = path.join('.', 'QBTable.browserify.min.js');
